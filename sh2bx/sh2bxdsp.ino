...
void dsp_scr_ship1(int force)
{
  ...
  if((force == 1) ||
    ...
    lcd.setCursor(0,2);
    lcd.print("mLc=");
    printSpaces(g_sh1_mlc,6);
    l_mlc=g_sh1_mlc;
    lcd.setCursor(10,2);
    lcd.print("mRc=");
    printSpaces(g_sh1_m2c,6);
    l_m2c=g_sh1_m2c;
...
void dsp_scr_ship2(int force)
{
  ...
  if((force == 1) ||
    ...
    if(g_sh1_mlon == 0) {
      ...
      lcd.print(g_sh1_mlc,10);
      if(g_sh1_mlc > 99) lcd.print("  ");
      else lcd.print("    ");
    }
    l_mlc=g_sh1_mlc;
...
void dsp_scr_ship3(int force)
{
  ...
  if(l_mode == 2) {
    if(l_oi == 1) {
      ...
      if(g_key == '1') {
        l_sh1_mlon=(l_sh1_mlon+1)%2;
      } else if(g_key == '3') {
        l_sh1_m2on=(l_sh1_m2on+1)%2;
      } else if(g_key == UCCB_KEY_ENTER) {
        g_sh1_mlon=l_sh1_mlon;
